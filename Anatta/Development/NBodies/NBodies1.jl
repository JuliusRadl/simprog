...
function animate( nb::NBody, t, x, p)
	...
	#= Julius' Kommentar:
	Die Werte aus dem ersten Vektor x = sin.(t)
	bilden den x-Anteil der Punkte, die
	Werte aus dem zweiten Vektor p = cos.(t) bilden
	den y-Anteil.

	Dadurch entsteht ein Kreis: cos(t)
	sinkt erst mit zunehmendem t, während
	sin(t) steigt. Das heißt, wir fangen rechts
	am Kreis an und bewegen uns nach links (wegen
	sinkendem cos(t)) und nach oben (wegen steigendem
	sin(t)), also gegen den Uhrzeigersinn!! =#
