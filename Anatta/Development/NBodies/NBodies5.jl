...
Demonstrate simulation of a chaotic 4-body system.
"""
function demo()
	...
	addbody!( nb, [-3.0, 0.0],	[ 0.0, -0.1],	0.3)		# Planet (m = 0.3)
...
Demonstrate simulation of a chaotic 3-sun system.
"""
function demo2()
	# Build the 3-body system:
	nb = NBody( 20, 1000)
	addbody!( nb, [0.0, 1.0],	[ 0.8, 0.0], 	2.0)		# Sun 1 (m = 2)
	addbody!( nb, [0.0,-1.0],	[-0.8, 0.0],	2.0)		# Sun 2 (m = 2)
	addbody!( nb, [sqrt(3), 0.0],	[-0.8, 0.0],	2.0)		# Sun 3 (m = 2)
